...
export function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 w-full z-40 border-b border-emerald-200/50 dark:border-[#2A2F3A] bg-white/70 dark:bg-[#0B0F14]/80 backdrop-blur-md shadow-xs transition-colors duration-300">
      ...
      {/* Spacer to prevent page content overlapping under the fixed navbar */}
