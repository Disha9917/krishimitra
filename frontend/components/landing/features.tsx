    ...
    <section className="py-16 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <h2 className="text-3xl font-black text-slate-900 sm:text-4xl">Comprehensive AgriTech Platform Features</h2>
          <p className="text-sm text-slate-600">Built specifically for smallholder farmers to maximize yield and eliminate post-harvest losses.</p>
        </div>
