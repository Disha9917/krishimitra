...
export function TableHeader({ className, ...props }: React.HTMLAttributes<HTMLTableSectionElement>) {
  return <thead className={cn("bg-slate-50 text-xs font-semibold uppercase text-slate-500 border-b border-slate-100", className)} {...props} />;
}
...
export function TableHead({ className, ...props }: React.ThHTMLAttributes<HTMLTableCellElement>) {
  return <th className={cn("px-4 py-3.5 font-semibold text-slate-700", className)} {...props} />;
}
