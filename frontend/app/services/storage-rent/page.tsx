            ...
            <div className="pt-6 flex flex-wrap justify-center gap-2">
              ...
              <div className="inline-flex rounded-2xl bg-white/80 dark:bg-[#161B22]/90 p-1.5 border border-emerald-100 dark:border-[#2A2F3A] backdrop-blur-md shadow-sm">
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all cursor-pointer ${activeTab === "my-warehouses" ? "bg-emerald-600 text-white" : "text-slate-600 dark:text-[#8B949E] hover:bg-slate-100 dark:hover:bg-slate-800/40"}`}
                >
